...
import { Heart, Eye, Image as ImageIcon, Video } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20">
          ...
          <p className="text-gray-500 text-base mb-2">No liked posts yet</p>
          <p className="text-gray-600 text-sm">Posts you like will appear here</p>
        </div>
      ) : (
        /* Posts Grid */
